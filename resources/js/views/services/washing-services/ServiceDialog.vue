    ...
    watch: {
        service(val) {
            if(!!val) {
                ...
                this.formData.machineType = val.machine_type;
                this.formData.regularMinutes = val.regular_minutes;
                this.formData.additionalMinutes = val.additional_minutes;
                this.formData.points = val.points;
            } else {
                this.mode = 'insert';
